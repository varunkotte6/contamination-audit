...
Non-Pythia ground-truth replication. Mirrors phase3_v2_detect.py but with:
  ...
  - FT checkpoints: /mnt/localssd/checkpoints/gtolmo_{A,B,C,D,E}

Outputs to results/phase3_olmo/ for independent calibration.
"""
import argparse
import json
import os
...
BASE_MODEL = f"{LOCALSSD}/models/allenai__OLMo-2-0425-1B"
E5_MODEL = f"{LOCALSSD}/models/intfloat__e5-large-v2"
BENCH_DIR = f"{LOCALSSD}/data/benchmarks"
RESULTS = f"{PROJECT}/results/phase3_olmo"
...
def main():
    ...
    # Load training texts
    ft_dir = f"{PROJECT}/checkpoints/gtolmo_{variant}"
    training_texts = []
